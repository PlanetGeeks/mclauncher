...
public class InfoFrame extends JFrame
{
	...
	public void loadTranslations()
	{
		...
		if (!(creditsLabels[1] instanceof LinkLabel))
		{
		...
		{
			((LinkLabel) infoLabels[6]).setTextLink(LanguageUtils.getTranslated("launcher.info.creditslink"), LanguageUtils.getTranslated("launcher.info.creditslink"));
		}
		...
		if (!(infoLabels[6] instanceof LinkLabel))
		{
		...
		{
			((LinkLabel) infoLabels[6]).setTextLink(Settings.linkInfo, Settings.linkInfo);
		}
	}
